...
<html>
	...
	<title>Sistema de Ayuda::Nuevo Ticket</title>
</head>
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana puede generar nuevos tickets para Consultas y Reclamos.
				</p>
					...
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								...
								<select id="cats_id" name="cats_id" class="form-control" required>
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								...
								<select id="prio_id" name="prio_id" class="form-control" required>
